...
# Type 1 classes:
# @dataclass
# class PatientInformationClinicalImpression:
#     table_name = "Patient Information"
#     # Patient Information
#     last: str
#     first: str
#     middle: str
...
#     # The keys (e.g. "Last") are the labels in the PDF file, the values (e.g. 'last') are the names of the attributes in the class
#     variables = {
#         "Last": "last",
#         "First": "first",
#         "Middle": "middle",
...
# @dataclass
# class IncidentDetailsDestinationDetailsIncidentTimes:
#     # Incident Details
#     location_type: str = ""
#     location: str = ""
#     address: str = ""
